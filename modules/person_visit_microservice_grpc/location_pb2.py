...
_LOCATIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='latitude', full_name='LocationMessage.latitude', index=4,
...
_PERSONLOCATIONVISITSERVICE = _descriptor.ServiceDescriptor(
  name='PersonLocationVisitService',
  full_name='PersonLocationVisitService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Create',
    full_name='PersonLocationVisitService.Create',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_PERSONLOCATIONVISITSERVICE)

DESCRIPTOR.services_by_name['PersonLocationVisitService'] = _PERSONLOCATIONVISITSERVICE
