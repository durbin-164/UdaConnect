...
class PersonLocationVisitServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Create = channel.unary_unary(
                '/PersonLocationVisitService/Create',
...
class PersonLocationVisitServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_PersonLocationVisitServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'PersonLocationVisitService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class PersonLocationVisitService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/PersonLocationVisitService/Create',
